// src/bb_paxdata/interfaces/web/src/pages/BilateralRelations/components/BilateralCommandBar.tsx
...
interface BilateralCommandBarProps {
  mapContainerRef?: React.RefObject<HTMLDivElement>;
}

export const BilateralCommandBar = ({
  mapContainerRef: _mapContainerRef,
}: BilateralCommandBarProps) => {
